<?php
	...
	# 列出可删除的学期
	$sql = "SELECT DISTINCT `xueqi` FROM `jiaowu`;";
...
<h1 class="page-header">导入教务津贴数据</h1>
	...
	<article class="col-md-12 maincontent">
		...
		<form action="import_jiaowu_handle.php" method="post" enctype="multipart/form-data">
			<label for="file">选择文件:<a href="./../files/教务津贴.xls">请下载模板填写</a></label>
		...
		<br>
		<form class="form-horizontal" action="./import_jiaowu_delete_handle.php" method="post">
						<fieldset>
							<!-- Select Basic -->
							<h3>选择要删除的学期</h3>
