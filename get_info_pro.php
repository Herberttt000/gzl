				...
				<div class="span12">
					<table class="table table-condensed">
						...
						<tbody>
							...
							echo "<td>".$chengren_yuanshi."</td>";
							echo "<td>".$chengren_zhehe."</td>";
							echo "<td>".$chengren_shijianzhehe."</td>";
							echo "<td>".$shiyan_yuanshi."</td>";
							echo "<td>".$shiyan_zhehe."</td>";
							echo "<td>".$shiyan_jintie."</td>";
