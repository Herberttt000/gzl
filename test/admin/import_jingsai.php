<?php
	...
	# 列出可删除的学期
	$sql = "SELECT DISTINCT `xueqi` FROM `jingsai`;";
...
<h1 class="page-header">导入竞赛数据</h1>
	...
	<article class="col-md-12 maincontent">
		...
		<form action="import_jingsai_handle.php" method="post" enctype="multipart/form-data">
			<label for="file">选择文件:<a href="./../files/竞赛.xls">请下载模板填写</a></label>
			<input type="file" name="file" id="file" /> 
			<p class="help-block">请确定你的文件是xls格式.</p>
			<button type="submit" class="btn btn-danger">导入</button>
		</form>
		<br>
		<form class="form-horizontal" action="./import_jingsai_delete_handle.php" method="post">
						<fieldset>
							<!-- Select Basic -->
							<h3>选择要删除的学期</h3>
