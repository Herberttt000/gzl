...
<button class="btn btn-warning btn-xs" data-toggle="modal" data-target="#<?php echo $row['id'];?>_Modal">
  修改
</button><button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#<?php echo $row['id'];?>_add_Modal">
	添加
</button><button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#<?php echo $row['id'];?>_sm_Modal">删除</button>
